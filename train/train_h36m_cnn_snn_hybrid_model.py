...
if __name__ == '__main__':
    ...
    if flags.init_with_pretrained:
        ...
        h36m_hybrid_rgb_path = '/home/asude/master_thesis/experiments/checkpoints/HYBRID/2023-02-27_17-57-56_HYBRID_CNN_SNN_H36M_50Hz_lr0.0001_BS8_tau3.0_thr1.0_outputdecay0.8_200ms_epoch6.pt'
    ...
    if save_runs: 
        ...
        comment = '_HYBRID_CNN_SNN_H36M_100Hz_lr{}_BS{}_tau{}_thr{}_outputdecay{}_'.format(lr_value, batch_size, model_params_config.getfloat('tau'), model_params_config.getfloat('v_threshold'), model_params_config.getfloat('output_decay')) + flags.tb_name
    ...
    for epoch in range(training_config.getint('num_epochs')):
        ...
        for batch_id, sample_batched in enumerate(train_loader):
            ...
            if (not ((batch_id + 1) % 1000)) and save_runs:
                ...
                image = plot_batch_label_pred_tb_h36m(sample_batched, output.to('cpu'), mode='hybrid', grid_shape=(1,2), cnn_preds=cnn_output)
                ...
                with torch.no_grad(): # computational graphs are not created
                    ...
                    for val_batch_id, val_sample_batched in enumerate(val_loader):
                        ...
                        if val_batch_id == 1000 and save_runs:
                            ...
                            image = plot_batch_label_pred_tb_h36m(val_sample_batched, val_output.to('cpu'), mode='hybrid', grid_shape=(1,2))
