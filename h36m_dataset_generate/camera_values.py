'''
cam_val['h36m_cameras_intrinsic_params'][<# cam id>]
input:        cam_val['h36m_cameras_intrinsic_params'][0].keys()
results:      dict_keys(['id', 'center', 'focal_length', 'radial_distortion', 'tangential_distortion', 'res_w', 'res_h', 'azimuth'])

cam_val['h36m_cameras_extrinsic_params']['<suject name>'][<# cam id>]
example: ['h36m_cameras_extrinsic_params']['S1'][0]
'''
...
cam_val = {'h36m_cameras_intrinsic_params':h36m_cameras_intrinsic_params, 
            'h36m_cameras_extrinsic_params':h36m_cameras_extrinsic_params}
