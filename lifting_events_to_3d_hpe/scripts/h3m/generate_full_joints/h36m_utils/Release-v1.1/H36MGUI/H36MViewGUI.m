function varargout = H36MViewGUI(varargin)
...
% Last Modified by GUIDE v2.5 06-Nov-2012 16:50:53
...
if any(APPLICATION.subject == [db.test_subjects])
	...
	if APPLICATION.visualiser.MirrorSymmetric(handles.numview) && v>1
		APPLICATION.visualiser = APPLICATION.visualiser.setPose(handles.numview,v+3);
	else
